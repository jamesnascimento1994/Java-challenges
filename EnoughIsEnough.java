...
/*
 * Challenge Eight: Enough is enough!
 ...
 * Challenge Source: https://www.codewars.com/kata/554ca54ffa7d91b236000023
 */
...
public class EnoughIsEnough {
    public static int[] deleteNth(int[] elements, int maxOccurrences) {
        //Code here ;)
        int[] cache = {};
        if (elements.length == 0 || maxOccurrences < 1) return cache;
